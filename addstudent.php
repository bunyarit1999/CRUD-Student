...
<h4><i class="fas fa-user-plus"></i> เพิ่มข้อมูลนักศึกษา</h4>
    <hr>
        <form action=" " method="post" class="row g-3">
  
            <div class="col-md-6">
                <label for="Stu_id" class="form-label">รหัสนักศึกษา</label>
                <input class="form-control" type="number" name="Stu_id" placeholder="ป้อนชื่อรหัสนักศึกษา ... " required>
            </div>

            <div class="col-md-6">
                <label for="Name_Surname" class="form-label">ชื่อ - นามสกุล</label>
                <input class="form-control" type="text" name="Name_Surname" placeholder="ป้อนชื่อ - นามสกุล ..." required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input class="form-control" type="date" name="Birthday" value="1999-01-01" placeholder="ป้อนวัน/เดือน/ปีเกิด ...">
            </div>
            
            <div class="col-md-6">
                <label for="Department" class="form-label">สาขา</label>
                <input class="form-control" type="text"name="Department" placeholder="ป้อนสาขา ...">
            </div>

            <div class="col-md-6">
                <label for="Faculty" class="form-label">คณะ</label>
                <input class="form-control" type="text"name="Faculty" placeholder="ป้อนคณะ ...">
            </div>
